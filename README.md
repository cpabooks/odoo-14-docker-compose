...
``` bash
curl -s https://raw.githubusercontent.com/cpabooks/odoo-14-docker-compose/master/run.sh | bash -s odoo-one 10014 20014
```
...
``` bash
curl -s https://raw.githubusercontent.com/cpabooks/odoo-14-docker-compose/master/run.sh | bash -s odoo-two 11014 21014
```
